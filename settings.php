...
$global_settings = getenv('HOME') . '/Sites/global-d7-settings.php';
if (file_exists($global_settings)) {
  // If the name of the db is not the same as `basename(cwd())` set `$sitename`.
  $sitename = NULL;
  include_once $global_settings;
}
